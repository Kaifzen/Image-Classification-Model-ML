...
def load_saved_artifacts():
    ...
    with open("D:/Users/kaifa/Desktop/KAIF/CODE/ML Project Image Classifier/server/artifacts/class_dictionary.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open("D:/Users/kaifa/Desktop/KAIF/CODE/ML Project Image Classifier/server/artifacts/saved_model.pkl", 'rb') as f:
...
def get_b64_test_image_():
    with open('D:/Users/kaifa/Desktop/KAIF/CODE/ML Project Image Classifier/server/b64.txt') as f:
        return f.read()

if __name__ == '__main__':
    load_saved_artifacts()
    print(classify_image(get_b64_test_image_(), None))
